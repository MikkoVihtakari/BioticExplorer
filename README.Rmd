...
The app can be run on a desktop (i.e. your computer) for local files and on a [server](http://njord:8080/bioticexplorer/) for both local files and the entire IMR Biotic database.

## The server version

A server version of [Biotic Explorer is located on IMR servers](http://njord:8080/bioticexplorer/) and can be run through any modern web browser given that **you access it inside the firewall of the institute** (i.e. in the institute intranet or through a VPN). 
